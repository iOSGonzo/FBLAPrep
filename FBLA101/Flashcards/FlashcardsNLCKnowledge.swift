...
class FlashcardsNLCKnowledge: UIViewController{
    ...
    var frontImages = ["FCF1NLC","FCF2NLC","FCF3NLC","FCF4NLC","FCF5NLC","FCEnd"]
    var backImages = ["FCB1NLC","FCB2NLC","FCB3NLC","FCB4NLC","FCB5NLC","FCEnd"]
